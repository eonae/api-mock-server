...
var defaultConfig = process.argv.length === 3 && process.argv[2] === '--default';
var customConfig = process.argv.length === 4 && process.argv[2] === '--config';
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var configPath, config, mock, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, Promise.resolve().then(function () { return require(configPath); })];
                case 1:
                    config = (_a.sent()).config;
                    mock = new core_1.MockServer(config);
                    mock.listen();
                    return [3, 3];
                case 2:
                    err_1 = _a.sent();
